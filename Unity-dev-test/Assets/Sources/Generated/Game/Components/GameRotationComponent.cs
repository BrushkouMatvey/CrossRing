...
public partial class GameEntity {
    ...
    public void AddRotation(UnityEngine.Quaternion newQuaternion, float newSpeed) {
        var index = GameComponentsLookup.Rotation;
        var component = (RotationComponent)CreateComponent(index, typeof(RotationComponent));
        component.quaternion = newQuaternion;
        component.speed = newSpeed;
        AddComponent(index, component);
    }

    public void ReplaceRotation(UnityEngine.Quaternion newQuaternion, float newSpeed) {
        var index = GameComponentsLookup.Rotation;
        var component = (RotationComponent)CreateComponent(index, typeof(RotationComponent));
        component.quaternion = newQuaternion;
        component.speed = newSpeed;
